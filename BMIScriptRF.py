...
rf_param_grid = { # reduced for efficiency
    'max_depth': [200],#
    'max_features': [5],#, 5, 8, 10],
    'min_samples_leaf': [3,],
...
rf_grid_search = GridSearchCV(estimator=rf, param_grid=rf_param_grid, n_jobs = -1, cv = 6, verbose=2, scoring=delayed_scorer)
...
# The best parameters are {'max_depth': 200, 'max_features': 5, 'min_samples_leaf': 3, 'min_samples_split': 5, 'n_estimators': 300}
...
result = permutation_importance(rf_best_grid, x_train_s, y_train_s, n_repeats=4, random_state=seed)
